...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium kindergarten tuition, phonics, handwriting and early learning programs in Santhoshpuram, Chennai. Building strong foundations since 2009." },
      { name: "author", content: "CRIS Learning Centre" },
      { property: "og:title", content: "CRIS Learning Centre — Early Learning & Tuition in Chennai" },
      { property: "og:description", content: "Premium kindergarten tuition, phonics, handwriting and early learning programs in Santhoshpuram, Chennai. Building strong foundations since 2009." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CRIS Learning Centre — Early Learning & Tuition in Chennai" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600;700&display=swap" },
